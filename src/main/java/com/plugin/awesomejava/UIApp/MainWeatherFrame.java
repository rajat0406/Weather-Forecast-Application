...
public class MainWeatherFrame extends javax.swing.JFrame {
    ...
    private JLabel Max1TempLabel;
    private JLabel MinTempLabel;
    private JLabel Min1TempLabel;
    ...
    public MainWeatherFrame(FeedEntry entry) {
     ...
     private void initComponents() {
        ...
        Max1TempLabel = new JLabel();
        Min1TempLabel = new JLabel();
        ...
        /*PressureJLabel.setFont(new Font("Segoe UI", 0, 18));
        ...
        jPanel2.add(jSeparator3, new AbsoluteConstraints(300, 150, 10, 120));
         ...
         jLabel200.setIcon(new ImageIcon(getClass().getResource("/Thermometer-44.png"))); // NOI18N
         jPanel2.add(jLabel200, new AbsoluteConstraints(130, 230, 40, 50));

         jLabel201.setIcon(new ImageIcon(getClass().getResource("/Thermometer-44.png"))); // NOI18N
         jPanel2.add(jLabel201, new AbsoluteConstraints(130, 140, 40, 50));

         Min1TempLabel.setFont(new Font("Dialog", 0, 34)); // NOI18N
         Min1TempLabel.setForeground(new Color(255, 255, 255));
         Min1TempLabel.setText("51.8 °F");
         jPanel2.add(Min1TempLabel, new AbsoluteConstraints(20, 240, 150, -1));

         jLabel203.setFont(new Font("Segoe UI", 1, 18)); // NOI18N
         jLabel203.setForeground(new Color(255, 255, 255));
         jLabel203.setText("Min. Temp. ");
         jPanel2.add(jLabel203, new AbsoluteConstraints(20, 120, -1, -1));

         Max1TempLabel.setFont(new Font("Dialog", 0, 34)); // NOI18N
         Max1TempLabel.setForeground(new Color(255, 255, 255));
         Max1TempLabel.setText("75.2 °F");
         jPanel2.add(Max1TempLabel, new AbsoluteConstraints(20, 150, 150, -1));

         jLabel202.setFont(new Font("Segoe UI", 1, 18)); // NOI18N
         jLabel202.setForeground(new Color(255, 255, 255));
         jLabel202.setText("Max. Temp. ");
         jPanel2.add(jLabel202, new AbsoluteConstraints(20, 210, -1, -1));

         jSeparator6.setBackground(new Color(255, 255, 255));
         jSeparator6.setForeground(new Color(255, 255, 255));
         jSeparator6.setOrientation(SwingConstants.HORIZONTAL);
         jPanel2.add(jSeparator6, new AbsoluteConstraints(20, 200, 140, 200));
        ...
        DayLambel.setFont(new Font("Segoe UI", 0, 12));
        ...
        CurrentTempLabel.setFont(new Font("Segoe UI", 0, 56));
        ...
        jLabel37.setFont(new Font("Segoe UI", 1, 14));
        ...
        MONTempJLabel.setFont(new Font("Segoe UI", 1, 12));
        ...
        TUETempJLabel.setFont(new Font("Segoe UI", 1, 12));
        ...
        WEDTempJLabel.setFont(new Font("Segoe UI", 1, 12));
        ...
        THUTempJLabel.setFont(new Font("Segoe UI", 1, 12));
        ...
        SATTempJLabel.setFont(new Font("Segoe UI", 1, 12));
        ...
        SUNTempJLabel.setFont(new Font("Segoe UI", 1, 12));
        ...
        jLabel29.setFont(new Font("Segoe UI", 1, 14));
       ...
       /* jLabel18.setIcon(new ImageIcon(getClass().getResource("/Humidity_44px.png"))); // NOI18N
        ...
        DetailedLabel.setText("Last Updated: Tue Jun 26 13:00:00 2018");
       ...
       /* WindLabel.setFont(new Font("Segoe UI", 0, 18)); // NOI18N
        ...
        LocationLabel.setText("Hyderabad,In");
        jPanel2.add(LocationLabel, new AbsoluteConstraints(420, 50, 300, -1));
        ...
        jLabel6.setIcon(new ImageIcon(getClass().getResource("/simple_blue_background-wallpaper-1920x1080.jpg"))); // NOI18N
    ...
    private void RefreshIconLabelMouseClicked(MouseEvent evt) {                                              
        ...
        final BackgroundWorker worker = new BackgroundWorker(entry, DynJLabelList, CurrentTempLabel, DayLambel, DescriptionLabel,
                DetailedLabel, HumidityLabel, PressureJLabel, MaxTempLabel, MinTempLabel,Max1TempLabel,Min1TempLabel, WindLabel, WeatherDayIcon, RefreshIconLabel);
        worker.execute();
        timer.restart();
    }                                             
