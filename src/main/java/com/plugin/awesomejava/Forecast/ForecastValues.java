...
public class ForecastValues {
    ...
    private String Min1Temperature;
    private String Max1Temperature;
    ...
    public ForecastValues(String DateInformations, String Datetemperature, String MaxTemperature,
            String MinTemperature, String Max1Temperature, String Min1Temperature, String Humidity, String Pressure, String Clouds, String Wind_Speed) {
        this.DateInformations = DateInformations;
        this.Datetemperature = Datetemperature;
        this.MaxTemperature = MaxTemperature;
        this.MinTemperature = MinTemperature;
        this.Max1Temperature = Max1Temperature;
        this.Min1Temperature = Min1Temperature;
        this.Humidity = Humidity;
        this.Pressure = Pressure;
        this.Clouds = Clouds;
        this.Wind_Speed = Wind_Speed;
    ...
    public ForecastValues(String DateInformations, String Datetemperature, String MaxTemperature, String MinTemperature, String Max1Temperature, String Min1Temperature,
    ...
    public ForecastValues(String DateInformations, String MaxTemperature, String MinTemperature, String Min1Temperature, String Max1Temperature, String Datetemperature, Date DayofWeek,
    ...
    public void setMin1Temperature(String Min1Temperature){ this.Min1Temperature = Min1Temperature;}

    public void setMax1Temperature(String Max1Temperature){ this.Max1Temperature = Max1Temperature;}
    ...
    public String getMin1Temperature() { return Min1Temperature;}

    public String getMax1Temperature() { return Max1Temperature;}
